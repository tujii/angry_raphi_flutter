...
void main() {
  group('Correct Badge Logic Tests', () {
    ...
    setUp(() {
      testUsers = [
        User(id: '1', initials: 'S.C.', raphconCount: 9, createdAt: DateTime.now()),
        User(id: '2', initials: 'M.J.', raphconCount: 5, createdAt: DateTime.now()),
        User(id: '3', initials: 'J.D.', raphconCount: 5, createdAt: DateTime.now()),
        User(id: '4', initials: 'I.G.', raphconCount: 4, createdAt: DateTime.now()),
        User(id: '5', initials: 'R.U.', raphconCount: 3, createdAt: DateTime.now()),
      ];
    });
    ...
    test('should show correct badges: 1 Gold, 2 Silver, 1 Bronze', () {
      ...
      expect(shouldShowBadge(testUsers, 0), isTrue, reason: 'S.C. should get Gold');
      expect(shouldShowBadge(testUsers, 1), isTrue, reason: 'M.J. should get Silver');
      expect(shouldShowBadge(testUsers, 2), isTrue, reason: 'J.D. should get Silver (tied)');
      expect(shouldShowBadge(testUsers, 3), isTrue, reason: 'I.G. should get Bronze');
      expect(shouldShowBadge(testUsers, 4), isFalse, reason: 'R.U. should NOT get a badge');
    });
    ...
    test('should work with different score distributions', () {
      final allSameUsers = [
        User(id: '1', initials: 'A.A.', raphconCount: 5, createdAt: DateTime.now()),
        User(id: '2', initials: 'B.B.', raphconCount: 5, createdAt: DateTime.now()),
        User(id: '3', initials: 'C.C.', raphconCount: 5, createdAt: DateTime.now()),
      ];
    ...
    test('should work with exactly 3 unique scores', () {
      final exactlyThreeUsers = [
        User(id: '1', initials: 'A.A.', raphconCount: 10, createdAt: DateTime.now()),
        User(id: '2', initials: 'B.B.', raphconCount: 8, createdAt: DateTime.now()),
        User(id: '3', initials: 'C.C.', raphconCount: 6, createdAt: DateTime.now()),
        User(id: '4', initials: 'D.D.', raphconCount: 4, createdAt: DateTime.now()),
      ];
