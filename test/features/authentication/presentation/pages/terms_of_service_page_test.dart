...
import 'package:angry_raphi/features/authentication/presentation/pages/terms_of_service_page.dart';
...
void main() {
  ...
  group('TermsOfServicePage', () {
    ...
    testWidgets('should display terms of service title',
    ...
    testWidgets('should be a StatelessWidget', (WidgetTester tester) async {
      ...
      final termsOfServicePage = tester.widget<TermsOfServicePage>(
        find.byType(TermsOfServicePage),
      );

      expect(termsOfServicePage, isA<StatelessWidget>());
    });
